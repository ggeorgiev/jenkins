...
./b2 variant=release address-model=32 architecture=x86 --stagedir=./prebuilt/lib/linux/x86-32/release --with-system --with-filesystem --with-program_options --with-regex || exit 1
